...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-c1zlxf8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-c1zlxf8.containers.anotherwebservice.com/
...
```
git clone git@github.com:Moeweb647252/container-c1zlxf8.git
cd container-c1zlxf8
```
...
```
docker attach container-c1zlxf8
```
